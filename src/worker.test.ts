...
function fakeMeliFetch(options: { siteId?: string; exchangeStatus?: number; meStatus?: number; mePayload?: unknown; capabilityStatus?: number; onItems?: (count: number) => void } = {}): FetchLike {
  return async (input) => {
